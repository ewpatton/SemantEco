...
SemantEcoUI.overlays = new Object(); // TODO: This should probably be in a init function and not way down here
...
function addPolygonDrawListeners(aPolyline){
    ...
    var polyLineMapDoubleClickListener = google.maps.event.addListener(SemantEcoUI.map, 'dblclick', function() {
