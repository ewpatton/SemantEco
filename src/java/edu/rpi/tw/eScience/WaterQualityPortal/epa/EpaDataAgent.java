...
public class EpaDataAgent {
	...
	public EpaDataAgent(){
		...
		coliformConstraints = new HashMap<String, MeasurementConstraint> ();
	...
	private void processOCVPage(String zipCode, Facility curFac){
		...
		if(getTarget!=null) {
			...
			if(csvPostContent != null){
				...
				csvAgent.CSVRead(csvResult, curFac, coliformConstraints);
			}
		}
	}
...
/*	private String convertAddress(String address){
	...
	*/
	...
	void startQuery(String zipCode){
		...
		utilAgent.printMeasurementConstraintMap(coliformConstraints, constraintsFile);
	...
	public static void main(String[] args) {
		...
		dataAgent.startQuery("02809");//12208 12180
