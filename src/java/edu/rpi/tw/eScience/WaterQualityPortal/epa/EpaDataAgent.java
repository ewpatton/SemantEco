...
public class EpaDataAgent {
	...
	ArrayList<Facility> facilitiesWithViolations = new ArrayList<Facility>();
	...
	private void procFacilityPage(String zipCode, Facility curFac){
		...
		doCommunication(0, getTarget, getContent, facHtml);
	...
	private void getOCVPage(String zipCode, Facility curFac){
		...
		if(getTarget!=null)
			doCommunication(0, curFac.OCVLink, getContent, ocvHtml);		
	}
...
/*	private String convertAddress(String address){
	...
	*/
	...
	public static void main(String[] args) {
		...
		String getTarget = "http://www.epa-echo.gov/cgi-bin/effluents.cgi?permit=NY0261343&amp;charts=viols&amp;monlocn=all&amp;outt=all";
