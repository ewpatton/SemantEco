...
// Array that contains the name of the regulations for Canada goose
...
function plot_bird_count() {
	...
	d3.csv("readme2.csv", function(data) {
		...
		svg.append("svg:text")
			...
			.attr("font-size", "12px")
			.text("Bird count for Canada geese in Washington state in 2007");
