        ...
        if(xhttp.readyState==4) {
            if(xhttp.status==200) {
            	...
            	if(data.error!=undefined) {
            		...
            		mapLegend.appendChild(img);
            		mapLegend.appendChild(document.createTextNode("Water"));
            		img = document.createElementNS(XHTML,"img");
            		img.setAttribute("src","image/pollutedwater.jpg");
            		img.setAttribute("height","20");
            		mapLegend.appendChild(img);
            		mapLegend.appendChild(document.createTextNode("Polluted Water"));
            		img = document.createElementNS(XHTML,"img");
            		img.setAttribute("src","image/facility.jpg");
            		img.setAttribute("height","20");
            		mapLegend.appendChild(img);
            		mapLegend.appendChild(document.createTextNode("Facility"));
            		img = document.createElementNS(XHTML,"img");
            		img.setAttribute("src","image/facilitypollute.jpg");
            		img.setAttribute("height","20");
            		mapLegend.appendChild(img);
            		mapLegend.appendChild(document.createTextNode("Polluting Facility"));
