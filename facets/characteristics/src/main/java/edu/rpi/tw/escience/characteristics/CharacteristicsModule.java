...
public String queryIfTaxonomicCategoryForJstree(Request request) throws JSONException {
		...
		String candidateTaxonomicCategory = (String) request.getParam("queryIfCharacteristicTaxonomicCategoryForJstree");	
	  ...
	  //  String candidateTaxonomicCategoryString  = candidateTaxonomicCategory.toString();
		...
		final Variable characteristicVariable = query.getVariable(VAR_NS + "characteristic");	
	...
	@QueryMethod
	public String queryCharacteristicsTaxonomyRoots(Request request) throws IOException, JSONException{	
		final Query query = config.getQueryFactory().newQuery(Type.SELECT);	
		//Variables
		...
		final QueryResource owlTaxonomy = query.getResource("http://www.w3.org/2002/07/owl#Thing");
	...
	@QueryMethod
	public String queryCharacteristicsTaxonomySubClasses(Request request) throws IOException, JSONException{	
		
		String classRequiresSubclassesString = (String) request.getParam("queryCharacteristicsTaxonomySubClasses");	
